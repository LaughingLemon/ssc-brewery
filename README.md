# (A Copy of) Brewery Spring MVC Monolith

This repository contains source code examples used to support the Spring Guru on-line courses about the Spring Framework.
